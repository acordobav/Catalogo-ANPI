...
def adams_bashforth_p2(str_funcion, a, b, n, y0, y1):
    """
    ...
    h = (b - a) / (n - 1)
    x = a + h  # Variable para el x de la iteracion actual
    y = y1  # Variable para el y de la iteracion actual
    x_ant = a  # Variable para el x de la iteracion anterior
...
def adams_bashforth_p3(str_funcion, a, b, n, y0, y1, y2):
    """
...
def adams_bashforth_p4(str_funcion, a, b, n, y0, y1, y2, y3):
    """
    ...
    while x <= b - h:
        y_temp = y  # Variable temporal para guardar el valor de y
        y = y + h * (55 * funcion(x, y) - 59 * funcion(x_ant, y_ant) + 37 * funcion(x_ant_2, y_ant_2)
                     - 9 * funcion(x_ant_3, y_ant_3)) / 24
...
# resultado = adams_bashforth_p2('1 + (x - y) ** 2', 2, 4, 11, 1, 1.191)
# print(resultado)
#
